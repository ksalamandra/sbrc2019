...
plt.plot(x, np.asarray(k)/1000, 'b-o',label="Cliente 1", linewidth=wd, linestyle='dotted')
plt.plot(x, np.asarray(y)/1000, 'g-.', label="Cliente 2", linewidth=wd, markersize=20, markeredgewidth=4)
plt.plot(x, np.asarray(z)/1000, 'r-', label="Cliente 3", linewidth=wd)
plt.plot(x, np.asarray(m)/1000, 'k', label="Limite de banda médio L_{c}", linestyle='dotted', linewidth=wd)
#
